...
test('eval recommendation generator covers override and missing surface heuristics', () => {
...
test('recommendation artifacts can be accepted and surface as proposed claims before decision', async () => {
  ...
  store.policies.push({
    ...
    acceptanceCriteria: ['eval recommendation artifact'],
  ...
  const input = await buildSurfaceTrustInput({
    ...
    files: [],
    unresolved_files: [],
    adapter: { name: 'recommendation-test', kind: 'repo-adapter', report_transport: 'local-json' },
