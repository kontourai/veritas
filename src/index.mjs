...
function surfaceEvidence({ id, claimId, type, method, record, locator, summary, metadata = {} }) {
  return {
    id,
    claimId,
    evidenceType: type,
...
function surfaceEvent({ id, claimId, status, method, evidenceIds, record, notes, verifiedAt }) {
  return {
    id,
    claimId,
    status,
...
function surfacePolicyResultStatus(result) {
...
function surfaceProofFamilyImpact(family) {
...
function surfaceProofFamilyStrength(family) {
...
function surfaceProofFamilySummary(family) {
...
export function buildEvidenceRecord({
  ...
  return {
    ...record,
    surface: {
      input: buildSurfaceTrustInput(record),
    },
  };
}
