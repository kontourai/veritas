...
This plan was superseded by the current Veritas vocabulary in [CONTEXT.md](../../CONTEXT.md). Keep it as a short historical pointer instead of preserving old product language.
...
Use the active roadmap and backlog instead:

- [Roadmap](roadmap.md)
- [Implementation Backlog](implementation-backlog.md)
- [Product Naming Migration](../MIGRATING.md#product-terminology-migration)
