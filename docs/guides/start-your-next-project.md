...
13. then run `npm exec -- veritas apply codex-hook --codex-home /path/to/.codex`
14. or run `npm exec -- veritas apply codex-hook --target-hooks-file /path/to/hooks.json`
