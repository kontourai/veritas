...
These packs are starting points for common repo shapes. They are examples, not universal policy. Use `veritas init --pack <name>` to copy one into `.veritas/policy-packs/default.policy-pack.json`, then tune it for your repo.
